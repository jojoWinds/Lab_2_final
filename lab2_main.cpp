...
#include "lab2_drones_manager_test [grading-sample].hpp"
...
{
	bool result = 0;
	DronesManagerTest test_sample;
	result = test_sample.test1();
	cout << "test1() = " << result << endl;
	
	result = test_sample.test2();
	cout << "test2() = " << result << endl;
	
	result = test_sample.test3();
	cout << "test3() = " << result << endl;
	
	result = test_sample.test4();
	cout << "test4() = " << result << endl;
	
	result = test_sample.test5();
	cout << "test5() = " << result << endl;
	
	result = test_sample.test6();
	cout << "test6() = " << result << endl;
	
	result = test_sample.test7();
	cout << "test7() = " << result << endl;
	
	result = test_sample.test8();
	cout << "test8() = " << result << endl;
	
	result = test_sample.test9();
	cout << "test9() = " << result << endl;
	
	result = test_sample.test10();
	cout << "test10() = " << result << endl;
}
